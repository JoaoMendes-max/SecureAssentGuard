...
Central unit: **Raspberry Pi 4 Model B**. 5 V peripherals interface through an 8-channel
bidirectional logic level converter; servos and fan are driven via MOSFETs.
...
| Cooling | 12 V fan | GPIO + MOSFET |
| Alerts | Active buzzer + LED | GPIO + MOSFET |

## Power

```
Grid ─┬─ 12 V 6 A PSU ─┬─ DC-DC 5 V  ─ 5 V sensors / actuators
