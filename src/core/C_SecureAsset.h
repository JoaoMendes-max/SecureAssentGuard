...
#define SAMPLING_INTERVAL_DEFAULT 600
...
private:
    ...
    C_Monitor m_monitor_env_sensor;

    // ============================================
    // THREADS (Unique pointers for polymorphism)
    // ============================================
